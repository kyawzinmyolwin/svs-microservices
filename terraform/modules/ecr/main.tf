...
# Allows your EKS node IAM role to pull images.
# This is what lets pods on EKS nodes pull from ECR without extra credentials —
# the node's IAM role (attached via instance profile) grants the permission.
# =============================================================================
